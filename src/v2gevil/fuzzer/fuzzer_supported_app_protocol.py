...
"""Fuzzer classes for Supported App Protocol Request and Response messages"""

from typing import Optional
import logging
from .fuzz_datatypes import fuzz_schema_id, fuzz_response_code
from .fuzz_msg_general import general_msg_fuzzing_method

logger = logging.getLogger(__name__)


class FuzzerSupportedAppProtocolRes:
    """Fuzzer Class for Supported App Protocol Response message"""
...
class FuzzerSupportedAppProtocolReq:
    ...
    def __init__(self, msg_config: Optional[dict] = None):
        self.msg_config = msg_config

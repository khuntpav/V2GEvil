"""Fuzzer classes for Payment Service Selection request and response messages."""
...
class FuzzerPaymentServiceSelectionRes:
    """Fuzzer Class for Payment Service Selection Response message"""
